...
<div class="container">
        <header>
            ...
            <div class="pull-right">Theme: Teaching Guide -> Fruit Guide</div>
        </header>
        <main>
<?php
//compar ultimul raspuns daca e corect
 ...
 if($scorFinal<=5)
 {
  ...
  $result = $conn->query($sql);
    if ($result->num_rows<1)
    {
        ...
        VALUES( '$user' ,'$concept','$departament','medium','$scorFinal')" );
        $mysql->close();
...
?> 
        ...
        <div class="centerDiv"><a href="../../../FruitGuide.php" class="adws-submit"><i class="ion-android-exit"></i> Quit</a></div>
    </div> <!-- div container-->
<?php
 $_SESSION['score']=0;
?>    
