...
?>
    <div class="container">
        <header>
            ...
            <div class="pull-right">Theme: Teaching Guid -> Vegetable Guide</div>
        </header>
        <main>
            <form class="questionForm" action="try_yorself_veget_q4.php" method="post" >
 <?php 
mysql_connect('localhost','root','');
mysql_select_db('register-bd');
$concept = "TeachingGuid";
$departament = "VegetableGuide";
$level = "hard";
$order = '3' ;
...
?>                
        ...
        <div class="centerDiv"><a href="../../../VegetableGuide.php" class="adws-submit"><i class="ion-android-exit"></i> Quit</a></div>
    </div> <!-- div container-->
